...
public class MovieDetailsActivity extends AppCompatActivity {
                ...
                public void onResponse(Call<VideoResultsModel> call, Response<VideoResultsModel> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (response.body() != null) {
                            ...
                            bindDataToAdapter(mVideoResultsList);
                        }
                    } else {
                ...
                public void onResponse(Call<ReviewResultsModel> call, Response<ReviewResultsModel> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (response.body() != null) {
                            ...
                            bindDataToAdapter(mReviewResultsList);
                        }
                    } else {
    ...
    private void setupMovieDetails() {
        ArrayList<MovieModel> movieDetailsList = new ArrayList<>();
        movieDetailsList.add(mMovieDetails);
        bindDataToAdapter(movieDetailsList);
    }

    private void bindDataToAdapter(ArrayList<?> resultsList) {
        mRecyclerViewMovieDetails.setAdapter(new MovieDetailsAdapter(this, resultsList));
    }
}
